...
"}")
        ...
        self.label_27 = QtWidgets.QLabel(self.pageInfo)
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        ...
        self.buttonDocu = QtWidgets.QPushButton(self.frame_19)
        self.buttonDocu.setMinimumSize(QtCore.QSize(224, 64))
        font = QtGui.QFont()
        font.setPointSize(-1)
        font.setBold(True)
        font.setWeight(75)
        self.buttonDocu.setFont(font)
        self.buttonDocu.setCheckable(False)
        self.buttonDocu.setChecked(False)
        self.buttonDocu.setDefault(False)
        self.buttonDocu.setObjectName("buttonDocu")
        self.horizontalLayout_20.addWidget(self.buttonDocu)
...
"")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_27.setText(_translate("MainWindow", "<html><head/><body><p><span style=\" font-size:16pt; font-weight:600;\">Documentation</span></p></body></html>"))
        self.buttonDocu.setText(_translate("MainWindow", "   Show Documentation   "))
